...
*Note: All emoji may not be supported by some browsers or devices.*

### More emoji and details will be added soon (work in progress).
#### Wanna Contribute?
...
| - | elf | - | - | - | - | - |
| - | empty nest | - | - | - | - | - |
| 🔚 | END arrow | - | `:end:`, `:end_arrow:` | `U+1F51A` | `&#128282;` | `&#x1F51A;` |
| - | envelope | - | - | - | - | - |
| - | envelope with arrow | - | - | - | - | - |
| - | euro banknote | - | - | - | - | - |
| - | evergreen tree | - | - | - | - | - |
...
| - | face with monocle | - | - | - | - | - |
| - | face with open eyes and hand over mouth 2 | - | - | - | - | - |
...
| - | ice hockey | - | - | - | - | - |
| - | ice skate | - | - | - | - | - |
| 🆔 | ID button | - | `:id:`, `:id_button:` | `U+1F194` | `&#127380;` | `&#x1F194;` |
| - | identification card | - | - | - | - | - |
| - | inbox tray | - | - | - | - | - |
| - | incoming envelope | - | - | - | - | - |
...
| - | input symbols | - | - | - | - | - |
| - | jack o lantern | - | - | - | - | - |
| 🉑 | Japanese acceptable button | - | `:accept:` | `U+1F251` | `&#127569;` | `&#x1F251;` |
| 🈸 | Japanese application button | - | `:u7533:`, `:japanese_application_button:` | `U+1F238` | `&#127544;` | `&#x1F238;` |
| 🉐 | Japanese bargain button | - | `	:ideograph_advantage:` | `U+1F250` | `&#127568;` | `&#x1F250;` |
| 🏯 | Japanese castle | - | `:japanese_castle:` | `U+1F3EF` | `&#127983;` | `&#x1F3EF;` |
| ㊗️ | Japanese congratulations button | - | `	:congratulations:` | `U+3297` | `&#12951;` | `&#x3297;` |
| - | japanese discount button | - | - | - | - | - |
| 🎎 | Japanese dolls | - | `:dolls:`, `:japanese_dolls:` | `U+1F38E` | `&#127886;` | `&#x1F38E;` |
...
| 🏣 | Japanese post office | - | `:post_office:`, `:japanese_post_office:` | `U+1F3E3` | `&#127971;` | `&#x1F3E3;` |
| - | japanese prohibited button | - | - | - | - | - |
| - | japanese reserved button | - | - | - | - | - |
| - | japanese secret button | - | - | - | - | - |
| - | japanese service charge button | - | - | - | - | - |
| 🔰 | Japanese symbol for beginner | - | `:beginner:`, `:japanese_symbol_for_beginner:` | `U+1F530` | `&#128304;` | `&#x1F530;` |
